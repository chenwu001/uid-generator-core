...
import com.kj.uid.BitsAllocator;
import com.kj.uid.UidGenerator;
import com.kj.uid.buffer.BufferPaddingExecutor;
import com.kj.uid.buffer.RejectedPutBufferHandler;
import com.kj.uid.buffer.RejectedTakeBufferHandler;
import com.kj.uid.buffer.RingBuffer;
import com.kj.uid.exception.UidGenerateException;
 ...
 * @author tangyz
 */
@ConfigurationProperties(prefix = "kj.uid.cached-uid-generator")
